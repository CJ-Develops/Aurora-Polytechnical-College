                ...
                <table class="table table-striped custom-table" style="min-width: 800px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $courseCode }}</td>
                            <td>
                                <a href="{{ url()->current() }}?table=intended&editingIntendedApplicant={{ $data['fk_applicantID'] }}&campus={{ urlencode($data['campus']) }}" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        @endif
